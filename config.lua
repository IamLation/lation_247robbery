...
Config.Locations = {
    Registers = {
        ...
        vec3(162.21070861816, 6642.0131835938, 31.94776725769), -- Paleto Blvd (uncomment if using Gabz 24/7)
        vec3(813.35162353516, -781.05291748047, 26.423851013184) -- Otto's Grotto (uncomment if using Gabz Otto's Grotto)
    },
    Computers = {
        ...
        vec3(168.8938293457, 6642.8100585938, 31.740690231323), -- Paleto Blvd (uncomment if using Gabz 24/7)
        vec3(817.54010009766, -775.82873535156, 26.271017074585) -- Otto's Grotto (uncomment if using Gabz Otto's Grotto)
    },
    Safes = {
        ...
        vec3(171.18128967285156, 6642.26416015625, 32.09161758422851), -- Paleto Blvd (uncomment if using Gabz 24/7)
        vec3(819.6384887695312, -774.578369140625, 26.54402732849121) -- Otto's Grotto (uncomment if using Gabz Otto's Grotto)
    }
}
